    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark">Kelola Review</h1>
            </div><!-- /.col -->
          </div><!-- /.row -->
        </div><!-- /.container-fluid -->
      </div>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Tabel Review</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                  <table id="example1" class="table table-bordered table-striped">
                    <thead>
                      <tr align="center" valign="top">
                        ...
                        <th scope="col">Kepuasan Layanan</th>
                        <th scope="col" style="width: 270px;">Isi Review</th>
                    ...
                    <tbody>
                      <?php 
                      $i=1;
                      $sql = mysql_query("SELECT * FROM review JOIN pelanggan ON review.id_pelanggan=pelanggan.id_pelanggan ORDER BY review.id_review DESC");
                      while ($isi= mysql_fetch_array($sql)){
                        ?>
                        <tr align="center" valign="top">
                          <td><?php echo $i; ?></td>
                          <td><a href="../file-edit/detail_pelanggan.php?id=<?php echo $isi['id_pelanggan'];?>"><?php echo $isi['nama_pelanggan']; ?></a></td>
                          <td><?php echo $isi['kepuasan_layanan']; ?></td>
                          <td><?php echo $isi['isi_review']; ?></td>
                          <td>
                            <a  class="btn btn-info" title= "Lihat" href="../file-edit/detail_review.php?id=<?php echo $isi['id_review'];?>">Lihat</a>
                          </td>
                          <td><?php echo $isi['publikasi']; ?></td>
                     </tr>
                     <?php $i++; }; ?>
                   </tbody>
                 </table>
