                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    <thead>
                      <tr align="center" valign="top">
                        ...
                        <th scope="col" style="width: 5px;">ID Pemesanan</th>
                        <th scope="col">Jumlah Pembayaran</th> 
                        <th scope="col">Validasi Pembayaran</th>
                        <th scope="col" style="width: 100px;">Bukti Pembayaran</th>
                      </tr>
                    </thead>
                    <tbody>
                      <?php 
                      $i=1;
                      $sql = mysql_query("SELECT * FROM pembayaran JOIN pemesanan ON pembayaran.id_pemesanan=pemesanan.id_pemesanan JOIN pelanggan ON pemesanan.id_pelanggan=pelanggan.id_pelanggan");
                      while ($isi= mysql_fetch_array($sql)){
                        ?>
                        <tr align="center" valign="top">
                          <td><?php echo $i; ?></td>
                          <td><a href="../file-edit/detail_pelanggan.php?id=<?php echo $isi['id_pelanggan'];?>"><?php echo $isi['nama_pelanggan']; ?></a></td>
                          <td><?php echo $isi['tanggal_pembayaran']; ?></td>
                          <td><a href="../file-edit/detail_pemesanan.php?id=<?php echo $isi['id_pemesanan'];?>"><?php echo $isi['id_pemesanan']; ?></a></td>
                          <td><?php echo "Rp. ". number_format($isi['jumlah_pembayaran'], 0, ".", ".");?> </td>
                          <td><?php echo $isi['validasi_pembayaran']; ?></td>
                          <td> <a  class="btn btn-info" title= "Lihat" href="../file-edit/detail_pembayaran.php?id=<?php echo $isi['id_pembayaran'];?>">Lihat</a></td>
                     </tr>
                     <?php $i++; }; ?>
                   </tbody>
                 </table>
