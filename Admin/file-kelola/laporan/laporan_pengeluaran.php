...
$query=mysql_query("select * from pengeluaran where tanggal_pengeluaran order by tanggal_pengeluaran asc");
if ($query===FALSE){
	die (mysql_error()); }
...
$q=mysql_query("select sum(total) as total from pengeluaran");
if ($q===FALSE){
	die (mysql_error()); }
