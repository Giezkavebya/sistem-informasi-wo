...
$query=mysql_query("select * from pemasukan where tanggal_pemasukan between '$tanggal_awal' and '$tanggal_akhir' order by tanggal_pemasukan asc");
if ($query===FALSE){
	die (mysql_error()); }
	...
	$q=mysql_query("select sum(total_pemasukan) as total from pemasukan where tanggal_pemasukan between '$tanggal_awal' and '$tanggal_akhir' ");
	if ($q===FALSE){
		die (mysql_error()); }
