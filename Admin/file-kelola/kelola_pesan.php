												...
												<div class="table-responsive mailbox-messages">
													<table class="table table-hover table-striped">
														<tbody>
															<?php 
															$i=1;
															$sql = mysql_query("SELECT * FROM pesan_pelanggan JOIN pelanggan ON pesan_pelanggan.id_pelanggan=pelanggan.id_pelanggan ORDER BY pesan_pelanggan.tanggal_kirim DESC") or die(mysql_error());
															while ($isi= mysql_fetch_array($sql)){
																?>
																<tr>
																	<td class="mailbox-star"><a href="#"><i class="fa fa-envelope text-info"></i></a></td>
																	<td class="mailbox-name"><a href="../file-edit/detail_pelanggan.php?id=<?php echo $isi['id_pelanggan'];?>"><?php echo $isi['nama_pelanggan'];?></a></td>
																	<td class="mailbox-subject"><a href="../file-edit/baca_pesan.php?id=<?php echo $isi['id_pesanpelanggan'];?>" style="color: red;"onClick="this.style.color='black';"><?php echo $isi['isi_pesan'];?></a></td>
																	<td class="mailbox-attachment"></td>
																	<td class="mailbox-date"><?php echo $isi['tanggal_kirim'];?></td>
																</tr>
																<?php $i++; }; ?>
															</tbody>
														</table>
