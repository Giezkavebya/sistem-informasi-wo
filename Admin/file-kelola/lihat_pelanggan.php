    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark">Lihat Pelanggan</h1>
            </div><!-- /.col -->
          </div><!-- /.row -->
        </div><!-- /.container-fluid -->
      </div>
                    ...
                    <tbody>
                      ...
                      while ($isi= mysql_fetch_array($sql)){
                        ...
                        <tr align="center" valign="top">
                          ...
                          <td><?php echo $isi['nama_pasangan']; ?></td>
                          <td><?php echo $isi['no_telp']; ?></td>
                          <td>
                            <a  class="btn btn-info" title= "Lihat" href="../file-edit/detail_pelanggan.php?id=<?php echo $isi['id_pelanggan'];?>">Lihat</a>
                          </td>
                        </tr>
                        <?php $i++; }; ?>
                      </tbody>
