	...
	<div class="wrapper">
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
          ...
          <!-- Add icons to the links using the .nav-icon class
          	...
          	<li class="nav-item">
          		<a href="lihat_pelanggan.php" class="nav-link">
          	...
          	<li class="nav-item has-treeview">
          		<a href="kelola_pemesanan.php" class="nav-link">
          		...
          		<ul class="nav nav-treeview">
          			<li class="nav-item">
          				<a href="kelola_pembayaran.php" class="nav-link">
          	...
          	<li class="nav-item">
          		<a href="kelola_Pesan.php" class="nav-link">
          	...
          	<li class="nav-item">
          		<a href="kelola_review.php" class="nav-link">
          	...
          	<li class="nav-item has-treeview">
          		...
          		<ul class="nav nav-treeview">
          			<li class="nav-item">
          				<a href="kelola_jadwal_acara.php" class="nav-link">
          					<i class="fa fa-circle-o text-danger nav-icon"></i>
          					<p>Lihat Jadwal Acara</p>
          				</a>
          			</li>
          			<li class="nav-item">
          				<a href="kelola_jadwal_pertemuan.php" class="nav-link">
          					<i class="fa fa-circle-o text-info nav-icon"></i>
               ...
               <li class="nav-item has-treeview">
                    ...
                    <ul class="nav nav-treeview">
                         <li class="nav-item">
                              <a href="kelola_pemasukan.php" class="nav-link">
                                   <i class="fa fa-circle-o text-danger nav-icon"></i>
                                   <p>Lihat Pemasukan</p>
                              </a>
                         </li>
                         <li class="nav-item">
                              <a href="kelola_pengeluaran.php" class="nav-link">
                                   <i class="fa fa-circle-o text-info nav-icon"></i>
          	...
          	<li class="nav-item">
          		<a href="kelola_paket.php" class="nav-link">
          	...
          	<li class="nav-item">
          		<a href="kelola_layanan.php" class="nav-link">
          	...
          	<li class="nav-item">
          		<a href="kelola_tentang.php" class="nav-link">
          	...
          	<li class="nav-item">
          		<a href="kelola_inspirasi.php" class="nav-link">
          	...
          	<li class="nav-item">
          		<a href="kelola_alur.php" class="nav-link">
