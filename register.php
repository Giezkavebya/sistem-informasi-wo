    ...
    <div class="wrapper">
      <div class="inner">
        <div class="image-holder">
          <img src="regislogin/images/couple1.jpg" alt="">
        </div>
        <form action="aksi_tambah_akun.php" method="POST">
          <h3>Registrasi Akun</h3>
          <div class="form-wrapper">
            <input type="text" placeholder="Nama" name="nama_pelanggan" class="form-control">
          </div>
          <div class="form-wrapper">
